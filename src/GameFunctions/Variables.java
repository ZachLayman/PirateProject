...
public class Variables {     
    ...
    public static final int BOARD_HEIGHT = 499; //i only used a lot of 9s cus its my fav number lol 
    public static final int BOARD_WIDTH = 649;
    ...
    public static final int CANNON_SPEED = 7;
